...
const Contact = () => {
  return (
    <div className='max-w-[1400px] mx-auto px-6 md:px-10 flex flex-col md:flex-row items-center md:pt-25 pt-20 bg-zinc-800'>
      ...
      {/* Left Side */}
      <div className='w-1/2 mt-5 ml-15'>
        <div className='flex '>
          <div className='bg-white w-1/2 h-60 rounded-xl ml-13'>
          ...
          <div className='bg-white ml-85 w-65 h-60 rounded-xl absolute'>
            ...
            <p className='text-zinc-900 font-sm items-center justify-center flex'>888-0123-4567</p>
            <p className='text-zinc-900 font-sm items-center justify-center flex'>(Toll Free)</p>
          </div>
        </div>
        <div className='flex mt-5'>
          <div className='bg-white w-1/2 h-50 rounded-xl ml-13'>
          ...
          <div className='bg-white ml-85 w-65 h-50 rounded-xl absolute'>
      ...
      {/* Right Side */}
      <div className='w-1/2 bg-rose-200 p-20 mt-14 mr-30 rounded-xl mb-10'>
        <form className='pl-20'>
          <Heading highlight="Contact" heading="Us" className="mt-4" />
          <input type="text" placeholder='Enter Your Name' className='flex w-full p-2 mt-4 bg-white text-zinc-900' />
          <input type="email" placeholder='Enter a valid email address' className='flex w-full p-2 mt-4  bg-white text-zinc-900' />
          <textarea className='flex w-full p-2 mt-4 mb-4 h-25 bg-white text-zinc-900' />
          <div className='ml-25'>
